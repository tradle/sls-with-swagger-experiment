export const genOptionsBlock = ({ headers, origins, methods=[] }) => {
  methods = methods.filter(m => m.toUpperCase() !== 'OPTIONS')
  return {
    "consumes": [
      "application/json"
    ],
      ...
      "responses": {
        "default": {
          ...
          "responseParameters": {
            ...
            "method.response.header.Access-Control-Allow-Origin": `'${origins.join(',')}'`
          }
        }
      },
